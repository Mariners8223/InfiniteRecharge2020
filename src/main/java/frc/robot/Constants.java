...
public final class Constants {
    ...
    public static final double PATH_WEAVER_KS = 0.3;
    public static final double PATH_WEAVER_KV = 1.96;
    public static final double PATH_WEAVER_KA = 0.06;
    public static final double PATH_WEAVER_KP = 2.95;
